...
void wifi_init_sta(p_wifi_state_callback f)
{
    ...
    // 2. 创建网络接口
    esp_netif_sta = esp_netif_create_default_wifi_sta();  // STA接口
    //esp_netif_ap = esp_netif_create_default_wifi_ap();    // AP接口
    ...
    wifi_config_t wifi_config = {
        .sta = {
            .ssid = "OPPO Reno7 5G",      // 替换为您的WiFi名
            .password = "g86h3i9e",  // 替换为您的WiFi密码
